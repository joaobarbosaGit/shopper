...
export class InsertProducts1684078693950 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            ...
            (22,'ENERGÉTICO  RED BULL ENERGY DRINK SEM AÇUCAR 250ML',6.74,7.49),
            (23,'ÂGUA MINERAL BONAFONT SEM G�S 1,5L',2.15,2.39),
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `DELETE FROM products WHERE code = 16, 18, 19, 20, 21, 22, 23, 24, 26, 1000, 1010, 1020`
        );
    }
